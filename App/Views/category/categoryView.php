<div class="row"> <!--Контент-->
    ...
    <h1 align="center">Категория</h1>

    <div class="col-12">
        <a class="btn btn-primary" href="CategoryAdd">Добавить</a>
        <a class="btn btn-warning" href="/Category">Очистить</a>
    ...
    <table class="table mt-2 table-bordered table-striped table-primary" border="2">
        ...
        <tbody>
            ...
            foreach ($models as $category) { ?>
                <tr class="red">
                    <th class="th" scope="row"><?= $category->id ?></th>
                    <td class="td"><?= $category->name ?></td>

                    <td class="td">

                        <form action="CategoryRead" method="POST" style="display:inline">
                            <input type="hidden" name="ReadId" value="<?=$category->id?>">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="CategoryDelete" method="post">
                                            <input type="hidden" name="deletedId" value="<?= $category->id ?>">
                                            <button name="delete"
                        ...
                        <div class="modal fade" id="Update<?= $category->id ?>" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h4 align="center" class="text-primary mb-3">Изменить Категории - <?= $category->id ?></h4>
